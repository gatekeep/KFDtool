...
using KFDEKC.Container.FileStructure.DKF;

namespace KFDEKC.Container
{
    /// <summary>
    /// 
    /// </summary>
    public class ContainerUtilities
    {
        ...
        */
        ...
        public static InnerContainer CreateInnerContainer()
        {
            ...
            innerContainer.UKEKs = new ObservableCollection<RSIKeyItem>();
            innerContainer.NextUKEKNumber = 1;
            innerContainer.LLAs = new ObservableCollection<RSIKeyItem>();
            innerContainer.NextLLANumber = 1;
        ...
        public static byte[] EncryptOuterContainer(OuterContainer outerContainer, InnerContainer innerContainer, byte[] key)
        {
            ...
            byte[] fileBytes = KFDtool.Shared.Utility.Compress(outerContainerBytes);
        ...
        public static (OuterContainer ContainerOuter, InnerContainer ContainerInner, byte[] Key) DecryptOuterContainer(byte[] fileBytes, string password)
        {
            ...
            try
            {
                outerContainerBytes = KFDtool.Shared.Utility.Decompress(fileBytes);
            }
            catch (Exception ex)
            {
            ...
            string outerXml = Encoding.UTF8.GetString(outerContainerBytes);
            outerContainerXml.LoadXml(outerXml);
            ...
            if (innerReadVersionParsed.Major > 2)
                throw new Exception(string.Format("inner container version too new (this container was written on a newer software version) - expected 2, got {0}", innerReadVersionParsed.Major));
            ...
            string innerVersion = "2.0";
            innerContainer.Version = innerVersion;
